...
import businessrules.EvaluatePathWeight;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        GraphFileReader gfr = new GraphFileReader("./graphTest.txt");
        
        Graph g = gfr.readGraph();
        ...
        EvaluatePathWeight pathCalculator = new EvaluatePathWeight();
